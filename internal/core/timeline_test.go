...
func TestBuildVR9TracksPlacement(t *testing.T) {
	...
	tracks, devs := buildVR9Tracks(events, takes, SongRef{Number: 1, Name: "S"}, 44100, FormatMT2)
	assert.Empty(t, devs)
...
func TestBuildVR9TracksSkipsEmpty(t *testing.T) {
	...
	tracks, _ := buildVR9Tracks(events, takes, SongRef{Number: 1}, 44100, FormatMT2)
...
func TestBuildVR9TracksTruncatedTake(t *testing.T) {
	...
	tracks, devs := buildVR9Tracks(events, takes, SongRef{Number: 1}, 44100, FormatMT2)
	require.Len(t, tracks, 1)
